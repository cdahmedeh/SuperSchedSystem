...
//
//public class Run08Fast{
//	public static void main(String[] args) {
//		final HashMap<Integer,String> classList = Run08Generator.generateClassList(10);		 					//10 courses
//		final ArrayList<Student> students = Run08Generator.generateStudents(6, classList);						//6 students
//		
...
//				
//				ArrayList<CourseBlock> blocks = Run08Generator.generateBlocksBasedClassList(classList);
//						
//				for (CourseBlock block: blocks){
//					block.setCourseTime(Run08Generator.generateRandomTime(rng));
//				}
//				
...
//		ee.evolve(500, 5, new TargetFitness(0, false));
